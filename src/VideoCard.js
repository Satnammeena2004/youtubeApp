  ...
  return (
    <Link to={`/watch?v=${id?.videoId ?? id}`}>
      <div className="  p-2 rounded-lg *:text-sm flex flex-col m-2 min-h-80 text-[#f1f1f1]">
        <div className="  border-slate-500 rounded-md flex justify-center items-center overflow-hidden min-h-44">
          <img alt="video" src={thumbnails?.medium?.url} className="rounded-md scale-y-105 w-full" />
        </div>
        <div className='flex'>
